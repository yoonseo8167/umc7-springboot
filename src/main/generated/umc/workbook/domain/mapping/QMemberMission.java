...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1669438535L;
    ...
    public final umc.workbook.domain.QMember member;

    public final umc.workbook.domain.QMission mission;

    public final EnumPath<umc.workbook.domain.enums.MissionStatus> status = createEnum("status", umc.workbook.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.workbook.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.workbook.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
